...
const HashMapTestCases = () => {
    ...
    const formatSearchResults = (results) => {
        ...
        return results.map(([videoId, stats]) => 
            formatVideoStats(videoId, stats)
        ).join("\n");
    };
    ...
    const insertionTests = () => {
        ...
        const video1 = new VideoStats("First Video About Cool Monster", 1000, 50, 10000);
        const video2 = new VideoStats("Second Video", 2000, 100, 20000);
        
        // Create video stats with international characters and emojis
        const video3 = new VideoStats("✅ [258/2022]😎 O QUE DIZ O CANAL POTÊNCIA DE 10", 258, 1, 1);
        const video4 = new VideoStats("ドラクエ10 オフライン #71 潮風のディーバ", 33, 0, 0);
    ...
    const averageStatsTests = () => {
        ...
        console.log("Average stats for 'Video': " + hashmap.getAverageStatsForWord("Video"));
        console.log("Average stats for 'monster': " + hashmap.getAverageStatsForWord("monster"));
        console.log("Average stats for 'cool': " + hashmap.getAverageStatsForWord("cool"));
        console.log("Average stats for 'CANAL': " + hashmap.getAverageStatsForWord("CANAL"));
        console.log("Average stats for 'nonexistent': " + hashmap.getAverageStatsForWord("nonexistent"));

        ...
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                >
                    ...
                    <Box>
                        <Typography
                            sx={{ fontSize: "20px", marginBottom: "100px" }}
                            color={whiteColor}
                        >
                            Discription of Project
                        </Typography>
...
=======
                        ...
                        {/* Discription of project */}
                        <Box>
                            <Typography sx = {{fontSize: "20px", margin: '0 auto', marginBottom: "100px", width: "70%", }} color={whiteColor}>
                                YouTube Title Optimization Website Tools Used Material UI React.js 
                                Project Overview: We are developing a frontend-only website that compares the efficiency of two data structures: a Trie and a HashMap. 
                                Our goal is to visualize and analyze their performance in searching YouTube video titles.
                                <br/><br/>
                                Key Features Comparison of Data Structures: We implement both a Trie and a HashMap to compare their search performance. 
                                ...
                                Data Source: The dataset used for this project was sourced via YouTube's video ID dataset from 2019 (newest) and YouTube's API for finding the video title, comments, views, and likes.
...
=======
                                ...
                                <Box sx = {{display: "flex", flexDirection: "column", width: "300px", justifyContent: "center", gap: "10px"}}>
                                    <Link href="https://github.com/kingwhatthe" underline="always" sx = {{fontSize: "20px"}} target="_blank">
                                        Github
                                    </Link>
                                    <Link href="https://www.linkedin.com/in/sabalschuster/" underline="always" sx = {{fontSize: "20px"}} target="_blank">
                                        LinkedIn
                                    </Link>
                            ...
                            <Typography sx = {{fontSize: "20px", margin: '0 auto', marginBottom: "100px", width: "70%", }} color={whiteColor}>
                            Hi, I'm Sabal. I am a freshman at the University of Florida studying computer science. 
                            I am interested in front-end development and designed the animations for this website! 
                            My favorite language is C++, but I also know python, javascript, java, C#, React, and Arduino. 
                            I also enjoy playing tennis, going on nature walks, and spending time with my friends. 
                            Please enjoy using this awesome website to clickbait everyone to your YouTube video! 
                            </Typography>
                        </Box>

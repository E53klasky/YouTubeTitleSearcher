...
const commentsData = [
    {
        ...
        comment:
            "This generator helped me increase my click-through rate by 45%! My channel is growing faster than ever.",
    },
    {
        id: 2,
        name: "Mark Rodriguez",
    ...
    },
    {
        ...
        avatar: "/api/placeholder/50/50",
        comment:
            "I've tried other title generators, but this one understands YouTube's algorithm perfectly!",
    },
    {
        id: 6,
        name: "David Thompson",
    ...
    },
    {
        ...
        avatar: "/api/placeholder/50/50",
        comment:
            "My latest video went viral thanks to the perfect title! This generator is pure gold.",
    },
    {
        id: 10,
        name: "Michael Kim",
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                >
                    {/* Center content with YouTube button */}
                    <Box
                        sx={{
                            width: "100%",
                            flexGrow: 1,

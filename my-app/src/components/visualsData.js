...
function youtubeData() {
    let arr = [
        ...
        [
            "Exploring Abandoned Places in the Middle of Nowhere",
            292849,
            9243,
            167,
        ],
        ...
        [
            "We Bought the Cheapest HOUSE in the U.S. (See What Happened)",
            590204,
            39210,
            1043,
        ],
        ...
        [
            "This Is What Happens When You Go Over the Speed Limit 🚗",
            294103,
            8650,
            0,
        ], // comments off

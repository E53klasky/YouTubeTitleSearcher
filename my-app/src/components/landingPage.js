...
const commentsData = [
    {
        ...
        comment:
            "This analyzer helped me increase my click-through rate by 45%! My channel is growing faster than ever.",
    },
    {
        id: 2,
        name: "Mark Rodriguez",
        avatar: "/api/placeholder/50/50",
        comment:
            "I was struggling with title ideas until I found this tool. Now I never run out of catchy titles!",
    },
    {
        id: 3,
        name: "Jamie Lee",
        avatar: "/api/placeholder/50/50",
        comment:
            "Super easy to use and gives amazing results. My latest video got 10K views in just 24 hours!",
    },
    {
        id: 4,
        name: "Alex Chen",
        avatar: "/api/placeholder/50/50",
        comment:
            "As a new YouTuber, this tool has been a game-changer for my channel's growth strategy.",
    },
    {
        id: 5,
        name: "Emily Wilson",
        avatar: "/api/placeholder/50/50",
        comment:
            "I've tried other title analyzers, but this one understands YouTube's algorithm perfectly!",
    },
    {
        id: 6,
        name: "David Thompson",
        avatar: "/api/placeholder/50/50",
        comment:
            "My subscriber count doubled since I started using these catchy titles. Highly recommended!",
    },
    {
        id: 7,
        name: "Sophia Garcia",
        avatar: "/api/placeholder/50/50",
        comment:
            "The titles it suggests actually match my content and get me more views. I'm impressed!",
    },
    {
        id: 8,
        name: "Ryan Patel",
        avatar: "/api/placeholder/50/50",
        comment:
            "This tool saved me hours of brainstorming. Now I spend more time creating and less time on titles.",
    },
    {
        id: 9,
        ...
        avatar: "/api/placeholder/50/50",
        comment:
            "My latest video went viral thanks to the perfect title! This analyzer is pure gold.",
    },
    {
        id: 10,
        name: "Michael Kim",
        avatar: "/api/placeholder/50/50",
        comment:
            "Finally breaking 100K subs after using these title strategies. Can't thank this tool enough!",
    },
    {
        id: 11,
        name: "Taylor Scott",
        avatar: "/api/placeholder/50/50",
        comment:
            "The engagement on my videos improved dramatically with these attention-grabbing titles.",
    },
    {
        id: 12,
        ...
        avatar: "/api/placeholder/50/50",
        comment:
            "I was skeptical at first, but the results speak for themselves. My CTR is up by 32%!",
    },
];
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                >
                    {/* Center content - removed the button as requested */}
                    <Box
                        sx={{
                            width: "100%",
                            flexGrow: 1,
